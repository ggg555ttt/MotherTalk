...
if(!localStorage['mt-style'])localStorage['mt-style'] = 'rgb(255,255,255) transparent rgb(220,229,232)';
var names = JSON.parse(localStorage['mt-names']);
...
{
	if(JSON.parse(localStorage['heads'])[0] && JSON.parse(localStorage['heads'])[0][imgindex.replace('.','/')])
	{//自定义头像
