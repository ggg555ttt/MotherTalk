									...
									children: (0, m.jsx)(g,
									{
										...
										children: w.selectedList.map(function(e, n)
										{
											return (0, m.jsx)(j,
											{
												...
												width: 252,
												height: 252,
												src: e.no > 999 ? (headarr[e.no+'.'+e.index] ? headarr[e.no+'.'+e.index] : loadhead(e.no+'.'+e.index)) : "https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/char/ch".concat(e.no, "-").concat(e.index, ".jpg"),
						...
						children: (0, m.jsx)(k,
						{
							children: n.profile.map(function(e)
							{
								return (0, m.jsx)(c.t_,
								{
									...
									height: 252,
									alt: "profile",
									src: n.no > 999 ? (headarr[n.no+'.'+e] ? headarr[n.no+'.'+e] : loadhead(n.no+'.'+e)) : "".concat("https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/char/ch").concat(n.no, "-").concat(e, ".jpg"),
							...
							children: (0, m.jsxs)(P,
							{
								...
								children: [(0, m.jsxs)(S,
								{
									children: [(0, m.jsx)(c.NZ,
									{
										width: 252,
										height: 252,
										src: n.no > 999 ? (headarr[n.no+'.'+1] ? headarr[n.no+'.'+1] : loadhead(n.no+'.'+1)) : "https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/".concat("char/ch").concat(n.no, "-", 1, ".jpg"),
									...
									children: (0, m.jsxs)(eK,
									{
										children: [Array(80).fill(0).map(function(e, n)
										{
											return (0, m.jsx)(eX,
											{
												...
												onClick: function()
												{
													u("https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/image/emoticon/".concat('zh_cn', "/ClanChat_Emoji_").concat(n + 1, ".jpg"))
													//#u("image/emoticon/".concat(l, "/ClanChat_Emoji_").concat(n + 1, ".png"))
												},
												src: "".concat("https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/image/emoticon/").concat('zh_cn', "/ClanChat_Emoji_").concat(n + 1, ".jpg")
										...
										}), [, , , , ].fill(0).map(function(e, n)
										{
											return (0, m.jsx)(eX,
											{
												...
												onClick: function()
												{
													u("https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/image/emoticon/dummy/ClanChat_Emoji_".concat(n + 1, ".jpg"))
													//#u("image/emoticon/dummy/ClanChat_Emoji_".concat(n + 1, ".png"))
												},
												src: "".concat("https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/image/emoticon/dummy/ClanChat_Emoji_").concat(n + 1, ".jpg")
						...
						}) : (0, m.jsxs)(m.Fragment,
						{
							children: [(0, m.jsx)(eN.xu,
							{
								...
								children: (0, m.jsx)(eN.NZ,
								{
									...
									height: 252,
									width: 252,
									src: n.sCharacter.no > 999 ? (headarr[n.sCharacter.no+'.'+n.sCharacter.index] ? headarr[n.sCharacter.no+'.'+n.sCharacter.index] : loadhead(n.sCharacter.no+'.'+n.sCharacter.index)) : "https://ghproxy.com/https://raw.githubusercontent.com/ggg555ttt/MotherTalk/main/char/ch".concat(n.sCharacter.no, "-").concat(n.sCharacter.index, ".jpg"),
