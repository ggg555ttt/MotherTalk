									...
									children: (0, m.jsx)(g,
									{
										...
										children: w.selectedList.map(function(e, n)
										{
											return (0, m.jsx)(j,
											{
												...
												width: 252,
												height: 252,
												src: e.no >= 0 && headarr[e.no+'.'+e.index] ? headarr[e.no+'.'+e.index] : loadhead(e.no+'.'+e.index)+"click.gif",
						...
						children: (0, m.jsx)(k,
						{
							children: n.profile.map(function(e)
							{
								return (0, m.jsx)(c.t_,
								{
									...
									height: 252,
									alt: "profile",
									src: n.no >= 0 && headarr[n.no+'.'+e] ? headarr[n.no+'.'+e] : loadhead(n.no+'.'+e)+"click.gif",
							...
							children: (0, m.jsxs)(P,
							{
								...
								children: [(0, m.jsxs)(S,
								{
									children: [(0, m.jsx)(c.NZ,
									{
										width: 252,
										height: 252,
										src: n.no >= 0 && headarr[n.no+'.'+1] ? headarr[n.no+'.'+1] : loadhead(n.no+'.'+1)+"click.gif",
						...
						}) : (0, m.jsxs)(m.Fragment,
						{
							children: [(0, m.jsx)(eN.xu,
							{
								...
								children: (0, m.jsx)(eN.NZ,
								{
									...
									src: n.sCharacter.no >= 0 && headarr[n.sCharacter.no+'.'+n.sCharacter.index] ? headarr[n.sCharacter.no+'.'+n.sCharacter.index] : loadhead(n.sCharacter.no+'.'+n.sCharacter.index)+"edit.png",
