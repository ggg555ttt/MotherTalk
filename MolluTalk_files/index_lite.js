									...
									children: (0, m.jsx)(g,
									{
										...
										children: w.selectedList.map(function(e, n)
										{
											return (0, m.jsx)(j,
											{
												...
												width: 252,
												height: 252,
												src: e.no >= 999 && headarr[e.no+'.'+e.index] ? headarr[e.no+'.'+e.index] : loadhead(e.no+'.'+e.index)+"click.gif",
						...
						children: (0, m.jsx)(k,
						{
							children: n.profile.map(function(e)
							{
								return (0, m.jsx)(c.t_,
								{
									...
									height: 252,
									alt: "profile",
									src: n.no >= 999 && headarr[n.no+'.'+e] ? headarr[n.no+'.'+e] : loadhead(n.no+'.'+e)+"click.gif",
							...
							children: (0, m.jsxs)(P,
							{
								...
								children: [(0, m.jsxs)(S,
								{
									children: [(0, m.jsx)(c.NZ,
									{
										width: 252,
										height: 252,
										src: n.no >= 999 && headarr[n.no+'.'+1] ? headarr[n.no+'.'+1] : loadhead(n.no+'.'+1)+"click.gif",
						...
						children: (0, m.jsx)(ea.Xf,
						{
							...
							children: (0, m.jsxs)(ea.F0,
							{
								...
								}), (0, m.jsx)(eH,
								{
									...
									{
										children: [Array(0).fill(0).map(function(e, n)//#children: [Array(80).fill(0).map(function(e, n)
										{
											return (0, m.jsx)(eX,
											{
												alt: "emoji",
												...
												src: headarr[199+'.'+(n+1)] ? headarr[199+'.'+(n+1)] : loadhead(199+'.'+(n+1))+"click.gif"
												//#src: "".concat("https://server.raun0129.com/asset/", "image/emoticon/").concat(l, "/ClanChat_Emoji_").concat(n + 1, ".png")
											}, n)
										}), [].fill(0).map(function(e, n)//#}), [, , , , ].fill(0).map(function(e, n)
										{
											return (0, m.jsx)(eX,
											{
												alt: "emoji",
												...
												src: headarr[200+'.'+(n+1)] ? headarr[200+'.'+(n+1)] : loadhead(200+'.'+(n+1))+"click.gif"
						...
						}) : (0, m.jsxs)(m.Fragment,
						{
							children: [(0, m.jsx)(eN.xu,
							{
								...
								children: (0, m.jsx)(eN.NZ,
								{
									...
									src: n.sCharacter.no >= 999 && headarr[n.sCharacter.no+'.'+n.sCharacter.index] ? headarr[n.sCharacter.no+'.'+n.sCharacter.index] : loadhead(n.sCharacter.no+'.'+n.sCharacter.index)+"edit.png",
